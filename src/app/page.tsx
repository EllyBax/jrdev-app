...
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
				...
				<div className="mb-8 flex items-center justify-center gap-6">
					...
					<Link
						href="/register"
						className="rounded-lg border bg-[#363a3f] px-4 py-2 transition-all hover:bg-[#212122]"
					>
						Sign Up
					</Link>
				</div>
						...
						<div className="flex flex-wrap gap-2">
							{projects.map((project) => (
								<Link
									...
									href={project.url}
									className="rounded-full border border-transparent bg-[#212122] px-4 py-2 transition-all hover:border-amber-200"
								>
									{project.name}
								</Link>
							))}
