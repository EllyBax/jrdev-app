...
const members: Member[] = [
    ...
    { id: "clr1h2x0g0008jrp9m3n6p9q4", name: "Iris Lee", email: "iris.l@codelab.com", phone: "(555) 901-2345", organization: "CodeLab", level: "NOOB", levelProgress: 20 },
    { id: "clr1h2x0g0009jrp9r7s4t1v8", name: "Jack Thompson", email: "j.thompson@techcore.net", phone: "(555) 012-3456", organization: "TechCore", level: "AMATEUR", levelProgress: 45 },
    { id: "clr1h2x0g0010jrp9w5x8y3z7", name: "Kelly Wang", email: "k.wang@devstream.org", phone: "(555) 123-4567", organization: "DevStream", level: "INTERMEDIATE", levelProgress: 70 },
    { id: "clr1h2x0g0011jrp9a2b5c8d4", name: "Liam O'Connor", email: "liam.o@innovate.net", phone: "(555) 234-5678", organization: "Innovate Solutions", level: "10X", levelProgress: 92 },
    { id: "clr1h2x0g0012jrp9e6f9g2h7", name: "Maria Garcia", email: "m.garcia@techwave.com", phone: "(555) 345-6789", organization: "TechWave", level: "CODE NINJA", levelProgress: 87 },
    { id: "clr1h2x0g0013jrp9i4j7k0l3", name: "Nathan Kim", email: "n.kim@codebridge.org", phone: "(555) 456-7890", organization: "CodeBridge", level: "BYTE WIZARD", levelProgress: 94 },
    { id: "clr1h2x0g0014jrp9m8n1p4q9", name: "Olivia Chen", email: "o.chen@devmatrix.net", phone: "(555) 567-8901", organization: "DevMatrix", level: "TECH GURU", levelProgress: 89 },
    { id: "clr1h2x0g0015jrp9r3s6t9v2", name: "Peter Zhang", email: "p.zhang@softlab.com", phone: "(555) 678-9012", organization: "SoftLab", level: "DEBUGGING DEITY", levelProgress: 97 },
    { id: "clr1h2x0g0016jrp9w7x0y3z8", name: "Quinn Lee", email: "q.lee@techhub.org", phone: "(555) 789-0123", organization: "TechHub", level: "NOOB", levelProgress: 25 },
    { id: "clr1h2x0g0017jrp9a1b4c7d5", name: "Rachel Brown", email: "r.brown@devpoint.net", phone: "(555) 890-1234", organization: "DevPoint", level: "AMATEUR", levelProgress: 40 },
    { id: "clr1h2x0g0018jrp9e5f8g1h6", name: "Samuel Park", email: "s.park@innovacode.com", phone: "(555) 901-2345", organization: "InnovaCode", level: "INTERMEDIATE", levelProgress: 75 },
    { id: "clr1h2x0g0019jrp9i9j2k5l8", name: "Tara Wilson", email: "t.wilson@techforge.org", phone: "(555) 012-3456", organization: "TechForge", level: "10X", levelProgress: 93 }
];
            ...
            <div className="mx-auto max-w-[1200px] p-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <input
                        ...
                        className="px-4 py-2 bg-[#1a1a1b] border border-amber-200/20 rounded-lg focus:outline-none focus:border-amber-200 text-gray-300 w-64"
                    />
                </div>
                <hr className="my-6" />
                ...
                <div className="overflow-x-auto">
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="bg-[#212122] border-b border-amber-200/20">
                        ...
                        <tbody>
                            {filteredMembers.map((member, index) => (
                                <tr
                                    ...
                                    className="border-b border-amber-200/10 hover:bg-[#212122] transition-colors cursor-pointer"
                                >
